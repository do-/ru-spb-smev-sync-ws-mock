const groups = [
	{id: '01', label: 'Меры социальной поддержки (помощи), установленные законодательством субъекта Российской Федерации (за исключением мер социальной поддержки, предоставляемых единовременно)'},
	{id: '02', label: 'Меры социальной поддержки, предоставляемые в соответствии с законодательством Российской Федерации и законодательством субъекта Российской Федерации в натуральной форме по оплате пользования телефоном или денежная компенсация указанных расходов'},
	{id: '03', label: 'Меры социальной поддержки, предоставляемые в соответствии с законодательством Российской Федерации и законодательством субъекта Российской Федерации, в натуральной форме по оплате жилых помещений и коммунальных услуг, или денежная компенсация указанных расходов'},
	{id: '04', label: 'Меры социальной поддержки, предоставляемые в соответствии с законодательством Российской Федерации и законодательством субъекта Российской Федерации в натуральной форме по оплате проезда на всех видах пассажирского транспорта (городского, пригородного и междугородного) или денежная компенсация указанных расходов'},
	{id: '05', label: 'Иные меры социальной поддержки, предоставляемые гражданину'},
]	
...
select_dotation:
    ...
    function () {
    	...
    	const {rq: {MessageData: {AppData: {info: {person: {fNameCiv, iNameCiv, mNameCiv}, snils, startDate, endDate}}}}} = this
    	...
    	let beneficiary = `<beneficiary>
			<fNameCiv>${fNameCiv}</fNameCiv>
			<iNameCiv>${iNameCiv}</iNameCiv>
			<mNameCiv>${mNameCiv}</mNameCiv>
			<docDatCiv>1978-03-04T00:00:00.000Z</docDatCiv>
			</beneficiary>                           
			<beneficiarySnils>${snils}</beneficiarySnils>`
    	...
    	let dotations = ''; while (dt < dt_to) {
			...
			for (const group of groups) {
				...
				const n = Math.floor (2.1 * Math.random ()) 
				
				for (let i = 0; i < n; i ++) dotations += `
					  <dotation>
						 <grantGroup>${group.id}</grantGroup>
						 <grantGroupName>${group.label}</grantGroupName>
						 <grantName>Денежная выплата...</grantName>
						 <properties>
							<property>
							   <monthSum>${m}</monthSum>
...
9cp0kh/Y+Q==</ds:SignatureValue>
   ...
   <SOAP-ENV:Body wsu:Id="id-2200" xmlns:wsu="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd">
      <ns1:dotationResponse xmlns:ns1="http://smev.gosuslugi.ru/rev111111" xmlns:ds="http://www.w3.org/2000/09/xmldsig#">
         <ns1:Message>
            <ns1:Sender>
