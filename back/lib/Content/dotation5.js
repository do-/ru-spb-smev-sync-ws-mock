...
select_dotation5:
    ...
    function () {
    	...
    	let dotations = ''; while (dt < dt_to) {
			...
			dotations += `
                  <dotation>
                     <grantName>Денежная компенсация по стоимости жилого помещения гражданам, указанным в п. 2 постановления Правительства РФ от 2 августа 2005 г. N 475 «О предоставлении членам семей погибших (умерших) военнослужащих и сотрудников некоторых федеральных органов исполнительной власти компенсационных выплат в связи с расходами по оплате жилых помещений, коммунальных и других видов услуг»</grantName>
                     <properties>
                        <property>
                           <monthSum>${m}</monthSum>
...
9cp0kh/Y+Q==</ds:SignatureValue>
   ...
   <SOAP-ENV:Body wsu:Id="id-2200" xmlns:wsu="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd">
      <ns1:dotation5Response xmlns:ns1="http://smev.gosuslugi.ru/rev111111" xmlns:ds="http://www.w3.org/2000/09/xmldsig#">
         <ns1:Message>
            <ns1:Sender>
